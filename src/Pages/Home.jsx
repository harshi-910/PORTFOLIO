...
const StatusBadge = memo(() => (
  <div className="inline-block animate-float" data-aos="zoom-in" data-aos-delay="400">
    <div className="relative group">
      ...
      <div className="relative px-2 sm:px-4 py-1.5 sm:py-2 rounded-full bg-black/40 backdrop-blur-xl border border-white/10">
        <span className="bg-gradient-to-r from-[#6366f1] to-[#a855f7] text-transparent bg-clip-text text-xs sm:text-sm font-medium flex items-center">
          <Sparkles className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2 text-blue-400" />
          Ready to Innovate
        </span>
      </div>
    </div>
  ...
  <div className="space-y-1 sm:space-y-2" data-aos="fade-up" data-aos-delay="600">
    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight">
      <span className="relative inline-block">
        <span className="absolute -inset-1 sm:-inset-2 bg-gradient-to-r from-[#6366f1] to-[#a855f7] blur-2xl opacity-20"></span>
...
const WORDS = ["Data Science & Big Data Analyst", "Tech Enthusiast", "Backend Developer"];
const SOCIAL_LINKS = [
  { icon: Linkedin, link: "https://www.linkedin.com/in/harshitha910/" },
  { icon: Github, link: "https://github.com/harshi-910" },
  { icon: Twitter, link: "https://x.com/arshiii_910" },
  { icon: Telegram, link: "https://t.me/HarshithaMahadasu" },
];
...
const Home = () => {
  ...
  const lottieOptions = {
    ...
    className: `w-full h-full transition-all duration-500 ${
      isHovering 
        ? "scale-[140%] sm:scale-[135%] md:scale-[130%] lg:scale-[125%]"
        : "scale-[135%] sm:scale-[130%] md:scale-[125%] lg:scale-[120%]"
    }`,
    ...
    <div className="min-h-screen bg-[#030014] overflow-hidden" id="Home">
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center min-h-screen gap-4 sm:gap-6 lg:gap-10">
            {/* Left Column */}
            <div className="w-full lg:w-1/2 space-y-4 sm:space-y-6 text-center lg:text-left order-2 lg:order-1">
              <StatusBadge />
              <MainTitle />
              <div className="h-6 sm:h-8 flex items-center justify-center lg:justify-start" data-aos="fade-up" data-aos-delay="800">
                ...
                <span className="w-[2px] h-5 sm:h-6 bg-gradient-to-t from-[#6366f1] to-[#a855f7] ml-1 animate-blink"></span>
              </div>
              <p className="text-sm sm:text-base md:text-lg text-gray-400 max-w-md mx-auto lg:mx-0 leading-relaxed font-light" data-aos="fade-up" data-aos-delay="1000">
                I am a Tech Developer currently pursuing my B.Tech in Computer Science at KL University.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 items-center justify-center lg:justify-start" data-aos="fade-up" data-aos-delay="1400">
                <CTAButton href="#Portofolio" text="Projects" icon={ExternalLink} />
                <CTAButton href="#Contact" text="Contact" icon={Mail} />
              </div>
              <div className="flex gap-3 justify-center lg:justify-start" data-aos="fade-up" data-aos-delay="1600">
            ...
            <div className="w-full sm:w-5/6 lg:w-3/5 h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] relative flex items-center justify-center order-1 lg:order-2" onMouseEnter={() => setIsHovering(true)} onMouseLeave={() => setIsHovering(false)} data-aos="fade-left" data-aos-delay="600">
